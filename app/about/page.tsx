...
const timeline = [
  ...
  },
  {
    ...
    body: 'Reached financial freedom and chose to serve. Since Basic Combat Training, I have shared my financial system with 29+ soldiers. This website is how I reach thousands more.',
    highlight: true,
  },
]
    ...
    <main>
      ...
      <section className="trust-section">
        <div className="trust-grid">
          {[
            { num: '$801K',  label: 'Net Worth Built',   prefix: '$', suffix: 'K', countFrom: 100, countTo: 801 },
        ...
        <div className="about-intro-inner container">
          ...
          <div className="intro-body">
            ...
            >
              ...
              <span className="linkedin-connect-label">↗</span>
            </a>
          </div>
        </div>
      </section>
