/**
 * Joe's social channels — the single source of truth.
 * Used by the site footer and the /contact page, so adding a channel here
 * puts it in both places at once.
 *
 * `icon` is the `d` attribute of a single path on a 24x24 viewBox.
 */
